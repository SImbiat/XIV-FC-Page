...
if ($output == true) {
	if (file_exists("./cache/chars/".$id.".txt")) {
			echo file_get_contents("./cache/chars/".$id.".txt");
			exit;
	}
}
...
$charpage = "<head>
		<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">
		</head><title>".$member['bio']['name']."</title><script>
...
";
$charpage = $charpage . "<table width=\"872px\" class=\"memberstbl\"><tr><td><table style=\"height: 436px;\" class=\"levelstbl\">
...
<tr><td class=\"totalclass\" colspan=\"6\">Total: ".$member['levels']['curr']['totallvl']."</td><tr></table></td><td>
<span style=\"display: inline-block;position: relative;width: 320px;height: 436px;\">
...
if ($member['fc']['ranklvl'] == 6) {
	...
	if ($curtime - $member['fc']['ranklvlupd'] > 5184000) {
...
//@file_put_contents("./cache/chars/".$id.".txt", $charpage);
if ($output == true) {
	echo $charpage;
}
?>